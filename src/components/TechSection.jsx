  ...
  const boxes = [
    {
      ...
      customStyle: true,
      icon: <FaCode size={30} className="mb-4 text-green-400" />,
    },
    {
      title: "Languages",
      desc: "C++, Python",
      icon: <FaCode size={30} className="mb-4 text-blue-400" />,
    },
    {
      title: "Frontend Development",
      desc: "HTML & CSS, JavaScript, React.js, Tailwind CSS",
      icon: <FaReact size={30} className="mb-4 text-cyan-400" />,
    },
    {
      title: "Backend Development",
      desc: "Node.js & Express.js for building APIs and server-side logic efficiently.",
      icon: <FaServer size={30} className="mb-4 text-orange-400" />,
    },
    {
      title: "Database",
      desc: "SQL (MySQL) for relational data, NoSQL (MongoDB) for flexible schema design.",
      icon: <FaDatabase size={30} className="mb-4 text-yellow-400" />,
    },
    {
      title: "SEO Optimization",
      desc: "Optimizing websites for search engines to improve visibility and traffic.",
      icon: <FaSearchengin size={30} className="mb-4 text-pink-400" />,
    },
  ];
          ...
          {boxes.map((box, index) => (
            <div
              ...
              className={`group p-6 sm:p-8 transition-transform duration-300 flex flex-col justify-center items-center 
                ${
                  box.customStyle
                    ? "h-60 md:h-60 border-2 border-zinc-900/50 shadow-xl rounded-lg"
                    : "h-60 bg-zinc-900/50 border-2 border-zinc-900/50 shadow-lg rounded-lg"
                }
